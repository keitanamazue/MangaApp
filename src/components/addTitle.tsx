            ...
            >
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform border border-gray-300 shadow-xl bg-gray-50 rounded-xl">
                ...
                <div className="grid grid-cols-4 gap-2 mt-4">
                  <div className="text-black col-span-1 text-xl text-center">
                    Title
                  </div>
                  <input
                    className="text-black w-full h-10 col-span-3 p-2 bg-white border border-gray-300 rounded shadow appearance-none hover:border-gray-700"
                    value={title}
                    onChange={(e) => {
